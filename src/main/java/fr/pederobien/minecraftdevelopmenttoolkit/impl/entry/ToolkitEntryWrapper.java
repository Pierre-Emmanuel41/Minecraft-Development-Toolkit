...
import fr.pederobien.minecraftscoreboards.impl.EntryWrapper;
import fr.pederobien.minecraftscoreboards.interfaces.IEntry;

public abstract class ToolkitEntryWrapper<T extends IEntry> extends EntryWrapper<T> {
	 ...
	 */
	public ToolkitEntryWrapper(T source) {
		super(source);
	}
